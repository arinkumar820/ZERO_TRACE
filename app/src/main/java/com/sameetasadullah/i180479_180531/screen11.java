...
public class screen11 extends AppCompatActivity {
    ...
    //         DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Accounts");.Trim() // TODO: Replace with Supabase equivalent
    //         FirebaseAuth auth = FirebaseAuth.getInstance();.Trim() // TODO: Replace with Supabase equivalent
